...
med(dat, dep = "Y", pred = "X", med = "M", estMethod = "bootstrap", bootstrap = 500) # number of bootstrap, large number is preferred
med(dat, dep = "Y", pred = "X", med = "M", estMethod = "bootstrap", bootstrap = 500, ci = TRUE) # show confidence interval
